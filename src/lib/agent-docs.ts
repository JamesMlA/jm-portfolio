...
export function llmsTxt(): string {
  return [
    ...
    "## Reference",
    "",
    `- [Projects](${site.url}/#projects): five engineering case studies — cloud infrastructure, Kubernetes platform, CI/CD and automation, streaming infrastructure, AI/MLOps`,
    `- [Experience](${site.url}/#experience): role history with focus areas and dates`,
    `- [Skills](${site.url}/#skills): technologies grouped by engineering domain, with how each is used`,
    `- [How I think about infrastructure](${site.url}/#thinking): engineering principles and how they relate`,
    `- [Open source](${site.url}/#github): GitHub profile and selected public repositories`,
